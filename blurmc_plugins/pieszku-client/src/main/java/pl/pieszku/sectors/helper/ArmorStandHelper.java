            ...
            if (sendType.equals(SendType.UPDATE)) {
                ...
                if (isAlive() != null) {
                    ...
                    for (Object entity : this.entity) {
                        ...
                        ReflectionHelper.invoke(setCustomName, entity, new ChatComponentText(ChatUtilities.colored(entityArmorStandOne.getCustomName().getText())));
                        ...
                        pairList.add(new Pair<>(EnumItemSlot.HEAD, CraftItemStack.asNMSCopy(new ItemHelper(Material.PLAYER_HEAD, 1, (short) 3).setOwnerUrl(head).toItemStack())));
                        PacketPlayOutEntityEquipment packetPlayOutEntityEquipment = new PacketPlayOutEntityEquipment(entityArmorStand.getId(), pairList);
                    ...
                    for(int i = 0; i < this.displayName.size(); i++) {
                       ...
                       entityArmorStand.setCustomName(new ChatComponentText(ChatUtilities.colored(this.displayName.get(i))));
                    }
                    return;
                }
                for (String text : this.getDisplayName()) {
                    ...
                    Object entity = ReflectionHelper.newInstance(EntityWitherConstructor, EntityTypes.ARMOR_STAND, world);
                    ...
                    if (text != null && !text.isEmpty()) {
                        ReflectionHelper.invoke(setCustomName,
                                entity,
                               new ChatComponentText(ChatUtilities.colored(text)));

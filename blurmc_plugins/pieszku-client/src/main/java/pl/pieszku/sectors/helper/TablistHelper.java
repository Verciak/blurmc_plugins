    ...
    public void send(SendType sendType) {
        try {
            if (sendType.equals(SendType.UPDATE)) {
                ...
                Field header = PacketPlayOutPlayerListHeaderFooterClass.getDeclaredField("header");
                ...
                Field footer = PacketPlayOutPlayerListHeaderFooterClass.getDeclaredField("footer");
                ...
                for (int i = 0; i < 80; i++) {
                    ...
                    playerInfoDataList.add(ReflectionHelper.newInstance(PlayerInfoDataConstructor, packetPlayOutPlayerInfo, gameProfile, ping, EnumGamemode.CREATIVE, component));
                }
                ...
                for (int i = 0; i < 80; i++) {
                    ...
                    playerInfoDataList.add(ReflectionHelper.newInstance(PlayerInfoDataConstructor, packetPlayOutPlayerInfo, gameProfiles[i], ping, EnumGamemode.CREATIVE, component));
                }
